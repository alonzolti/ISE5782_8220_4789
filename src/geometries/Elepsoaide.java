...
public class Elepsoaide extends Geometry{
    ...
    public List<GeoPoint> findGeoIntersectionsHelper(Ray rayC,double max){
        ...
        if(Util.isZero(sqrt)){
            double t = sqrt / (2 * a);
            GeoPoint pt = new Intersectable.GeoPoint(this, new Point(h1*t + q1 , h2 * t + q2 , h3 * t + q3).subtract(centerOps));
        ...
        GeoPoint pt1 = new Intersectable.GeoPoint(this,new Point(h1*t1 + q1 , h2 * t1 + q2 , h3 * t1 + q3).subtract(centerOps)),
        pt2 =  new Intersectable.GeoPoint(this,new Point(h1*t2 + q1 , h2 * t2 + q2 , h3 * t2 + q3).subtract(centerOps));
