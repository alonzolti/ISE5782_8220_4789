...
public class TriangleTest {
    ...
    void testFindIntersections() {
        ...
        assertEquals(List.of(new Point(1.1, 1.1, 0)),
                t.findIntersections(new Ray(new Point(0, 1, 4), new Vector(1.1, 0.1, -4))), "ray intersect the plane");

        // TC02: don't intersect with the triangle, and against an edge(0 points)
        assertNull(t.findIntersections(new Ray(new Point(1, 1, 1), new Vector(-0.5, 0.5, -1))),
                "ray intersect point against an edge");

        // TC03: don't intersect with the triangle, and against a vertex(0 points)
        assertNull(t.findIntersections(new Ray(new Point(1, 1, 1), new Vector(-0.5, -0.5, -1))),
                "ray intersect point against a vertex");
        ...
        assertNull(t.findIntersections(new Ray(new Point(1, 1, 1), new Vector(-1, 0, -1))),
                "point of edg'e continuation");
    }
}
