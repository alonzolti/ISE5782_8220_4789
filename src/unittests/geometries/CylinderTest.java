...
//        assertEquals(new Vector(1, 0, 0), v1, "getNormal() wrong result ");
        assertTrue((new Vector(1, 0, 0).equals(v1) || new Vector(-1, 0, 0).equals(v1)), "getNormal() wrong result ");
...
// ============ Equivalence Partitions Tests on the sides ==============
        ...
        // TC01: Test that normal vector is righty
        assertTrue((new Vector(0, -1, 0).equals(v2) || new Vector(0, 1, 0).equals(v2)), "getNormal() wrong result ");
